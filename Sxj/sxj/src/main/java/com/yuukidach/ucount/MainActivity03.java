    ...
    private ItemTouchHelper.Callback ioCallback = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.RIGHT) {
        ...
        public void onSwiped(final RecyclerView.ViewHolder viewHolder, int direction) {
            ...
            if (direction == ItemTouchHelper.RIGHT) {
                // 弹窗确认
                AlertDialog.Builder builder = new AlertDialog.Builder(MainActivity03.this);
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                ...
                case R.id.add_button:
                    Intent intent = new Intent(MainActivity03.this, AddItemActivity.class);
                    startActivity(intent);
                    break;
                ...
                case R.id.add_book_button:
                    ...
                    final EditText book_title = new EditText(MainActivity03.this);
                    // 弹窗输入
                    AlertDialog.Builder builder = new AlertDialog.Builder(MainActivity03.this);
