...
public class IOItemAdapter extends RecyclerView.Adapter<IOItemAdapter.ViewHolder>
    ...
    public void onClick(View view) {
        Log.e("ssssssssssssss", "onClick: " + myOnClickListener);
        if (myOnClickListener != null) {
            myOnClickListener.OnItemClickListener(view, (Integer) view.getTag());
        }
    }

    @Override
    public boolean onLongClick(View view) {
        Log.e("ssssssssssssss", "onClick: " + myOnLongClickListener);
        if (myOnLongClickListener != null) {
            myOnLongClickListener.OnItemLongClickListener(view, (Integer) view.getTag());
        }
        return true;
    }


    public List<IOItem> mIOItemList;
