...
public class IOItem extends DataSupport  implements java.io.Serializable   {
    ...
    // 返回图片资源的id
    public int getSrcId() {
        Resources resources = MainActivity04.resources;
        return resources.getIdentifier(srcName, "drawable", MainActivity04.PACKAGE_NAME);
    }
}
