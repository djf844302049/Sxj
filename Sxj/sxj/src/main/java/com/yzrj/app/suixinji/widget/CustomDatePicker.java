package com.yzrj.app.suixinji.widget;
...
public class CustomDatePicker {
    ...
    public CustomDatePicker(Context context, View view, String startDate, String endDate) {
    ...
    public long getTimeInMillis() {
        return selectedCalender.getTimeInMillis();
    }
    ...
    public void setSelectedTime(String time) {
        if (canAccess) {
            ...
            day.clear();
            int selectedMonth = selectedCalender.get(Calendar.MONTH) + 1;
            if (selectedYear == startYear && selectedYear == endYear && selectedMonth == startMonth && selectedMonth == endMonth) {
                for (int i = startDay; i <= endDay; i++) {
                    day.add(formatTimeUnit(i));
                }
            } else if (selectedYear == startYear && selectedMonth == startMonth) {
