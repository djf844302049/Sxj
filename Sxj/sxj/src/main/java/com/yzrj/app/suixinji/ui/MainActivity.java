...
import com.yzrj.app.suixinji.MyApplication;
import com.yzrj.app.suixinji.Net.NetWork;
import com.yzrj.app.suixinji.Net.Weather;
...
import com.yzrj.app.suixinji.dialogs.AboutDialogFragment;
import com.yzrj.app.suixinji.dialogs.AddDialogFragment;
import com.yzrj.app.suixinji.dialogs.ChooseCityDialogFragment;
import com.yzrj.app.suixinji.dialogs.SetWallPaperFragment;
import com.yzrj.app.suixinji.fragments.DailyFragment;
...
public class MainActivity extends RxAppCompatActivity implements View.OnClickListener, ChooseCityDialogFragment.CityInputListener, SetWallPaperFragment.onSetWallPaperOK, AddDialogFragment.AddDutyInputListener {
    ...
    private void initView() {
        ...
        //vpAdapter.addFragment(new DailyFragment().newInstance("待办"), "待办");
        vpAdapter.addFragment(new DailyFragment().newInstance("日记"), "日记");
        vpAdapter.addFragment(new DailyFragment().newInstance("账单"), "账单");
        vpAdapter.addFragment(new DailyFragment().newInstance("纪念日"), "纪念日");
    ...
    public void onCityInputComplete(String cityname) {
        NetWork.getWeatherApi().getWeatherInfo(cityname, MyApplication.API_KEY)
